...
Win32::Interface - Win32 Network Adapter Interface

=head1 SYNOPSIS

  use Win32::Interface;

  my $interface = Win32::Interface->new('Wireless Network Connection');
...
Win32::Interface is a module to retrieve Windows interface adapter 
...
=head2 new() - create a new Win32::Interface object

  my $interfaces = Win32::Interface->new([OPTIONS]);

Create a new Win32::Interface object with OPTIONS as optional parameters.
Valid options are:
...
=head2 interfaces() - list available interfaces
  ...
  my $interfaces = Win32::Interface->interfaces;

List available interfaces by friendly name.

  Context   Usage                                Return
  -------   -----                                ------
  none      Win32::Interface->interfaces;       (print list)
  SCALAR    $i = Win32::Interface->interfaces;  array ref
  ARRAY     @i = Win32::Interface->interfaces;  array

=head2 lookupMac() - lookup IPv4 address MAC address

  my $mac = Win32::Interface->lookupMac(ipv4_addr);

Return MAC address for provided IPv4 address.

=head2 lookupMac6() - lookup IPv6 address MAC address

  my $mac = Win32::Interface->lookupMac6(ipv6_addr);

Return MAC address for provided IPv6 address.

=head1 EXPORTS

Load them: C<use Win32::Interface qw(:subs)>:
